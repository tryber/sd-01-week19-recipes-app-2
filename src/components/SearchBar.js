    ...
    <Router>
      <div className="search-bar">
        ...
        <div className="row-radio-buttons">
          <label for="ingredient-search-radio" className="label-ingredient">
            <input
          ...
          <label for="name-search-radio" className="label-name">
            <input data-testid="name-search-radio" className="radio-name" type="radio" />
            Nome
          </label>
          <label for="first-letter-search-radio" className="label-firstletter">
            <input
